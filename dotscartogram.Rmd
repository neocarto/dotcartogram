...
**Ce document technique accompagne l'article intitulé "Le Dot cartogram " de Françoise Bahoken et Nicolas Lambert. Il propose une collection de "cartes à points" réalisées en langage R à partir de données de population et de richesse à l'échelle mondiale. Pour assurer la traçabilité et la reproductibilité, les codes sources (R) sont détaillés tout au long du document..**
...
Fonction pour creer un template cartographique
...
dotscartogram <- function(var = "pop", year = 2018, itermax = 10,
...
file <- "maps/dotscartogrampop2018.png"

if (!file.exists(file)){
  png(file, width = 2000, height = 1120, res = 150)
  dotscartogram(var = "pop",year = 2018, itermax = 70, onedot = 10000,
...
<a href ="maps/dotscartogrampop2018.png" target = "_BLANK"><img src ="maps/dotscartogrampop2018.png" width = "100%"></img></a>


```{r eval=TRUE, message=FALSE, warning=FALSE}

file <- "maps/dotscartogramgdp2018.png"

if (!file.exists(file)){
  png(file, width = 2000, height = 1120, res = 150)
  dotscartogram(var = "gdp",year = 2018, itermax = 70, onedot = 100,
...
<a href ="maps/dotscartogramgdp2018.png" target = "_BLANK"><img src ="maps/dotscartogramgdp2018.png" width = "100%"></img></a>

Bien sûr, nous pouvons modifier la taille et la valeur de chaque point.

```{r eval=TRUE, message=FALSE, warning=FALSE}

file <- "maps/dotscartogramgdp2018_v2.png"

if (!file.exists(file)){
  png(file, width = 2000, height = 1120, res = 150)
  dotscartogram(var = "gdp",year = 2018, itermax = 100, onedot = 20,
...
<a href ="maps/dotscartogramgdp2018_v2.png" target = "_BLANK"><img src ="maps/dotscartogramgdp2018_v2.png" width = "100%"></img></a>

## Dot Cartogram (amélioration)

Ici, nous ajoutons le paramètre "position" à la fonction dotscartogramme afin que les points puissent être disposés de manière régulière ou aléatoire à l'intérieur des pays, et non plus seulement répartis à partir du centroïde. Les trois cartes suivantes vous permettent de visualiser l'effet de ce paramètre.

```{r eval=TRUE, message=FALSE, warning=FALSE}

dotscartogram2 <- function(var = "pop", year = 2018, itermax = 10,
...
file <- "maps/center_dotscartogramgdp2018.png"

if (!file.exists(file)){
  png(file, width = 2000, height = 1120, res = 150)
  dotscartogram2(var = "gdp",year = 2018, itermax = 100, onedot = 60,
...
<a href ="maps/center_dotscartogramgdp2018.png" target = "_BLANK"><img src ="maps/center_dotscartogramgdp2018.png" width = "100%"></img></a>

A map with position = "random"

```{r eval=TRUE, message=FALSE, warning=FALSE}

file <- "maps/random_dotscartogramgdp2018.png"
...
if (!file.exists(file)){
  ...
  dotscartogram2(var = "gdp",year = 2018, itermax = 100, onedot = 60,
                radius = 80000, col = red, 
                position = "random",
                title = "Dots cartogram du PIB (random)",
                unit = "milliards de $")
  dev.off()
...
<a href ="maps/random_dotscartogramgdp2018.png" target = "_BLANK"><img src ="maps/random_dotscartogramgdp2018.png" width = "100%"></img></a>
...
file <- "maps/regular_dotscartogramgdp2018.png"
...
if (!file.exists(file)){
  ...
  dotscartogram2(var = "gdp",year = 2018, itermax = 100, onedot = 60,
                radius = 80000, col = red, 
                position = "regular",
                title = "Dots cartogram du PIB (regular)",
                unit = "milliards de $")
  dev.off()
...
<a href ="maps/regular_dotscartogramgdp2018.png" target = "_BLANK"><img src ="maps/regular_dotscartogramgdp2018.png" width = "100%"></img></a>
...
if (!file.exists(file)){
  ...
  choroLayer(x = circles, var = "s", method = "q6", col = cols,
             legend.title.txt = "Gdp per capita (in $)",
...
dotscartogram4 <- function(var = "pop", year = 2018, itermax = 10,
...
file <- "maps/dotscartogrampop2018_alter.png"

if (!file.exists(file)){
  png(file, width = 2000, height = 1120, res = 150)
  dotscartogram4(var = "pop",year = 2018, k = kpop, itermax = 20, divide = 50, col = blue,
            title = "Population mondiale, en 2018 (divide = 50)")
  dev.off()
...
<a href ="maps/dotscartogrampop2018_alter.png" target = "_BLANK"><img src ="maps/dotscartogrampop2018_alter.png" width = "100%"></img></a>


```{r eval=TRUE, message=FALSE, warning=FALSE}

file <- "maps/dotscartogramgdp2018_alter.png"

if (!file.exists(file)){
  png(file, width = 2000, height = 1120, res = 150)
  dotscartogram4(var = "gdp",year = 2018, k = kgdp, itermax = 20, divide = 50, col = red,
            title = "PIB mondial en 2018 (divide = 50)")
  dev.off()
...
<a href ="maps/dotscartogramgdp2018_alter.png" target = "_BLANK"><img src ="maps/dotscartogramgdp2018_alter.png" width = "100%"></img></a>
...
if (!file.exists(file)){
   png(file, width = 2000, height = 1120, res = 150)
   dotscartogram(var = "gdp",year = year, itermax = 100, onedot = 40,
...
if (!file.exists(file)){
   png(file, width = 2000, height = 1120, res = 150)
   dotscartogram(var = "pop",year = year, itermax = 100, onedot = 4000,
...
if (!file.exists(file)){
frames <- c("maps/drolingpop2018.png", "maps/dotscartogrampop2018.png")
m <- image_read(frames)
...
if (!file.exists(file)){
frames <- c("maps/drolinggdp2018.png","maps/dotscartogramgdp2018.png")
m <- image_read(frames)
m <- image_animate(m, fps = 2)
image_write(m, file)
}
